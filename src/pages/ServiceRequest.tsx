...
export const ServiceRequestPage: React.FC = () => {
  ...
  return (
    <div className="flex flex-col min-h-screen bg-gray-50">
      <Header />
      <main className="flex-grow w-full max-w-4xl mx-auto py-12 px-4 my-20">
        <form
          onSubmit={handleSubmit}
          className="bg-white p-8 rounded-xl shadow-md pb-12"
        >
          ...
          <div className="space-y-6">
            ...
            <div className="pb-5">
              ...
              <Popover>
                ...
                <PopoverContent
                  className="w-auto p-3 bg-white border rounded-xl shadow-lg "
                  side="bottom"
                  align="start"
                >
                  <MyDatePicker onSendData={handleSendData} />
                </PopoverContent>
              </Popover>
            </div>
